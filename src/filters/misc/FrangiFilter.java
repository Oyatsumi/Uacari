...
public class FrangiFilter extends Filter{
	...
	private int sigmaStart = 1, sigmaEnd = 1, sigmaStep = 1;
	...
	public FrangiFilter(final Image image, final float beta1, final float beta2, final int sigmaStart, final int sigmaEnd, final int sigmaStep){
		this.setImage(image);
		this.setBeta(beta1, beta2);
		this.setSigmaEnd(sigmaEnd);
		this.setSigmaStart(sigmaStart);
	...
	public void setSigmaStart(final int sigmaStart){
		this.sigmaStart = sigmaStart;
	}
	public void setSigmaEnd(final int sigmaEnd){
		this.sigmaEnd = sigmaEnd;
	}
	public void setSigmaStep(final int sigmaStep){
